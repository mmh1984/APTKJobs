...
public class Companyimage extends Activity implements OnClickListener{
	ImageView cimage;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.companyimage);
		
		cimage=(ImageView) findViewById(R.id.companyimg);
		Button save=(Button) findViewById(R.id.btnsaveimg1);
	...
	public void save_img() {
		...
		File dir=new File(filepath.getAbsolutePath() + "/aptkimages/company");
		dir.mkdirs();
		
		File file=new File(dir,get_user() + ".png");
		
		Toast.makeText(Companyimage.this,"Image saved to sd card",Toast.LENGTH_SHORT).show();
		...
		try {
			...
			output.flush();
			output.close();
			Intent in=new Intent(Companyimage.this,Companymenu.class);
